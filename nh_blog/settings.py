"""
Django settings for nh_blog project.
...
SECRET_KEY = 's%xq)0^zu#qc6js82w_n*_1+(i4*36+mpjijh6*0t0l9r_z@$n'
...
WSGI_APPLICATION = 'nh_blog.wsgi.application'
...
JET_SIDE_MENU_ITEMS = [  # A list of application or custom item dicts
    {'label': '内容管理', 'app_label': 'my_blog', 'items': [
        {'name': 'article'},
        {'name': 'tag'},
        {'name': 'category'},
    ]},
